          ...
          <Form>
            ...
            <div className="inputs flex flex-col gap-2 ">
              ...
              {errors.password && touched.password ? (
               ...
               <button type='submit' className=" butn bg-transparent shadow-lg w-20  h-5   ml-[100px] text-sm md:h-6 md:ml-[150px] md:mt-3  mt-2  text-black font-semibold border border-gray-500 rounded-lg ">
                LOGIN 
                </button>
