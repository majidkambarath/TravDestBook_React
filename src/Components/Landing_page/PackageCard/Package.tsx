...
export default function Package() {
  ...
  return (
    <>
      <div>
        <h1 className="text-lg font-Ariza font-semibold py-7 px-7">
          JUST GO. GO SEE ALL THE BEAUTY IN THE WORLD
        </h1>
        <div className="h-1 w-1/4 bg-yellow-400 ml-7 -mt-4 rounded "></div>
      </div>
          ...
          return (
            <NavLink to={`/packageCategory/${items._id}`}>
              <div className="items cursor-pointer" key={items._id}>
                <h1 className="absolute text-white shadow-xl underline  drop-shadow-lg text-xl font-bold font-Yatra py-5 px-4">
                  {" "}
