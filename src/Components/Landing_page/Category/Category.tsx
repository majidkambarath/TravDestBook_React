...
export default function () {
  return (
    <div className='categoryContainer bg-zinc-100  w-full  '>
        <div className="Mainheading pt-10 ml-3 gap-2 ">
          <h1 className='Cate font-serif font-bold text-4xl'>Categories</h1>
       ...
       <div className="categoryMain mt-5 flex flex-col gap-2 md:flex-row overflow-x-scroll overflow-y-hidden ">
